...
// @Tag(name = "Authentication", description = "사용자 인증 API") - Swagger 일시 제거
public class AuthController {

    private final AuthService authService;

    @PostMapping("/register")
    // @Operation(summary = "회원가입", description = "새로운 사용자를 등록합니다") - Swagger 일시 제거
    ...
    @PostMapping("/login")
    // @Operation(summary = "로그인", description = "사용자 로그인을 수행합니다") - Swagger 일시 제거
